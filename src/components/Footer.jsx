	...
	return (
		<>
			{window.innerWidth < 1440 ? (
				<footer className="bg-darkBlue py-10 px-16 flex flex-col items-center space-y-10 text-white">
					...
					<RequestButton />
					<span className="text text-grayishBlue"> © Easybank. All Rights Reserved</span>
				</footer>
			) : (
				<footer className="  bg-darkBlue  ">
					<div className=" container mx-auto py-10 px-16 flex flex-row justify-between items-start text-white">
						<div className="flex flex-col space-y-14 w-32">
							<svg xmlns="http://www.w3.org/2000/svg" width="139" height="20">
								<defs>
									<linearGradient id="a" x1="72.195%" x2="17.503%" y1="0%" y2="100%">
										<stop offset="0%" stop-color="#33D35E" />
